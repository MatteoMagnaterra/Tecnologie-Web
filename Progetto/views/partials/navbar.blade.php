        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="{{ route('dipartimenti') }}" class="nav-item nav-link {{ Request::is('dipartimenti') ? 'active' : '' }}">Dipartimenti</a>

                    <!-- <div class="nav-item dropdown">
                        <a href="{{ route('dipartimenti')}}" class="nav-link dropdown-toggle {{ Request::is('dipartimenti') ? 'active' : '' }}" data-bs-toggle="dropdown">Dipartimenti</a>
